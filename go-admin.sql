CREATE TABLE `sys_casbin_rule` (`id` integer,`ptype` text,`v0` text,`v1` text,`v2` text,`v3` text,`v4` text,`v5` text,`v6` text,`v7` text,PRIMARY KEY (`id`));
CREATE TABLE `sys_dept` (`dept_id` integer,`parent_id` integer,`dept_path` text,`dept_name` text,`sort` integer,`leader` text,`phone` text,`email` text,`status` integer,`create_by` integer,`update_by` integer,`created_at` datetime,`updated_at` datetime,`deleted_at` datetime,PRIMARY KEY (`dept_id`));
...
CREATE TABLE `sys_config` (`id` integer,`config_name` varchar(128),`config_key` varchar(128),`config_value` varchar(255),`config_type` varchar(64),`is_frontend` varchar(64),`remark` varchar(128),`create_by` integer,`update_by` integer,`created_at` datetime,`updated_at` datetime,`deleted_at` datetime,PRIMARY KEY (`id`));
...
CREATE TABLE `sys_tables` (`table_id` integer,`table_name` text,`table_comment` text,`class_name` text,`tpl_category` text,`package_name` text,`module_name` text,`module_front_name` text,`business_name` text,`function_name` text,`function_author` text,`pk_column` text,`pk_go_field` text,`pk_json_field` text,`options` text,`tree_code` text,`tree_parent_code` text,`tree_name` text,`tree` numeric DEFAULT false,`crud` numeric DEFAULT true,`remark` text,`is_data_scope` integer,`is_actions` integer,`is_auth` integer,`is_logical_delete` text,`logical_delete` numeric,`logical_delete_column` text,`created_at` datetime,`updated_at` datetime,`deleted_at` datetime,`create_by` integer,`update_by` integer,PRIMARY KEY (`table_id`));
CREATE TABLE `sys_columns` (`column_id` integer,`table_id` integer,`column_name` text,`column_comment` text,`column_type` text,`go_type` text,`go_field` text,`json_field` text,`is_pk` text,`is_increment` text,`is_required` text,`is_insert` text,`is_edit` text,`is_list` text,`is_query` text,`query_type` text,`html_type` text,`dict_type` text,`sort` integer,`list` text,`pk` numeric,`required` numeric,`super_column` numeric,`usable_column` numeric,`increment` numeric,`insert` numeric,`edit` numeric,`query` numeric,`remark` text,`fk_table_name` text,`fk_table_name_class` text,`fk_table_name_package` text,`fk_label_id` text,`fk_label_name` text,`created_at` datetime,`updated_at` datetime,`deleted_at` datetime,`create_by` integer,`update_by` integer,PRIMARY KEY (`column_id`));

CREATE TABLE `sys_menu` (`menu_id` integer,`menu_name` text,`title` text,`icon` text,`path` text,`paths` text,`menu_type` text,`action` text,`permission` text,`parent_id` integer,`no_cache` numeric,`breadcrumb` text,`component` text,`sort` integer,`visible` text,`is_frame` text,`create_by` integer,`update_by` integer,`created_at` datetime,`updated_at` datetime,`deleted_at` datetime,PRIMARY KEY (`menu_id`));
INSERT INTO sys_menu VALUES(2,'Admin','系统管理','api-server','/admin','/0/2','M','无','',0,1,'','Layout',10,'0','1',0,1,'2021-05-20 21:58:45.679','2022-08-09 16:30:01',NULL);
INSERT INTO sys_menu VALUES(3,'SysUserManage','用户管理','user','/admin/sys-user','/0/2/3','C','无','admin:sysUser:list',2,0,'','/admin/sys-user/index',10,'0','1',0,1,'2021-05-20 22:08:44.526','2022-08-09 16:30:01',NULL);
INSERT INTO sys_menu VALUES(43,'','新增管理员','app-group-fill','','/0/2/3/43','F','POST','admin:sysUser:add',3,0,'','',10,'0','1',0,1,'2021-05-20 22:08:44.526','2022-08-09 16:30:01',NULL);
INSERT INTO sys_menu VALUES(44,'','查询管理员','app-group-fill','','/0/2/3/44','F','GET','admin:sysUser:query',3,0,'','',40,'0','1',0,1,'2021-05-20 22:08:44.526','2022-08-09 16:30:01',NULL);
INSERT INTO sys_menu VALUES(45,'','修改管理员','app-group-fill','','/0/2/3/45','F','PUT','admin:sysUser:edit',3,0,'','',30,'0','1',0,1,'2021-05-20 22:08:44.526','2022-08-09 16:30:01',NULL);
INSERT INTO sys_menu VALUES(46,'','删除管理员','app-group-fill','','/0/2/3/46','F','DELETE','admin:sysUser:remove',3,0,'','',20,'0','1',0,1,'2021-05-20 22:08:44.526','2022-08-09 16:30:01',NULL);
INSERT INTO sys_menu VALUES(51,'SysMenuManage','菜单管理','tree-table','/admin/sys-menu','/0/2/51','C','无','admin:sysMenu:list',2,1,'','/admin/sys-menu/index',30,'0','1',0,1,'2021-05-20 22:08:44.526','2022-08-09 16:30:01',NULL);
INSERT INTO sys_menu VALUES(52,'SysRoleManage','角色管理','peoples','/admin/sys-role','/0/2/52','C','无','admin:sysRole:list',2,1,'','/admin/sys-role/index',20,'0','1',0,1,'2021-05-20 22:08:44.526','2022-08-09 16:30:01',NULL);
INSERT INTO sys_menu VALUES(56,'SysDeptManage','部门管理','tree','/admin/sys-dept','/0/2/56','C','无','admin:sysDept:list',2,0,'','/admin/sys-dept/index',40,'0','1',0,1,'2021-05-20 22:08:44.526','2022-08-09 16:30:01',NULL);
INSERT INTO sys_menu VALUES(57,'SysPostManage','岗位管理','pass','/admin/sys-post','/0/2/57','C','无','admin:sysPost:list',2,0,'','/admin/sys-post/index',50,'0','1',0,1,'2021-05-20 22:08:44.526','2022-08-09 16:30:01',NULL);
INSERT INTO sys_menu VALUES(58,'Dict','字典管理','education','/admin/dict','/0/2/58','C','无','admin:sysDictType:list',2,0,'','/admin/dict/index',60,'0','1',0,1,'2021-05-20 22:08:44.526','2022-08-09 16:30:01',NULL);
INSERT INTO sys_menu VALUES(59,'SysDictDataManage','字典数据','education','/admin/dict/data/:dictId','/0/2/59','C','无','admin:sysDictData:list',2,0,'','/admin/dict/data',100,'1','1',0,1,'2021-05-20 22:08:44.526','2022-08-09 16:30:01',NULL);
INSERT INTO sys_menu VALUES(60,'Tools','开发工具','dev-tools','/dev-tools','/0/60','M','无','',0,0,'','Layout',40,'0','1',1,1,'2020-04-11 15:52:48.000','2022-08-09 16:30:01',NULL);
INSERT INTO sys_menu VALUES(61,'Swagger','系统接口','guide','/dev-tools/swagger','/0/60/61','C','无','',60,0,'','/dev-tools/swagger/index',1,'0','1',1,1,'2020-04-11 15:52:48.000','2022-08-09 16:30:01',NULL);
INSERT INTO sys_menu VALUES(62,'SysConfigManage','参数管理','swagger','/admin/sys-config','/0/2/62','C','无','admin:sysConfig:list',2,0,'','/admin/sys-config/index',70,'0','1',0,1,'2021-05-20 22:08:44.526','2022-08-09 16:30:01',NULL);
INSERT INTO sys_menu VALUES(211,'Log','日志管理','log','/log','/0/2/211','M','','',2,0,'','/log/index',80,'0','1',0,1,'2021-05-20 22:08:44.526','2022-08-09 16:30:01',NULL);
INSERT INTO sys_menu VALUES(212,'SysLoginLogManage','登录日志','logininfor','/admin/sys-login-log','/0/2/211/212','C','','admin:sysLoginLog:list',211,0,'','/admin/sys-login-log/index',1,'0','1',0,1,'2021-05-20 22:08:44.526','2022-08-09 16:30:01',NULL);
INSERT INTO sys_menu VALUES(216,'OperLog','操作日志','skill','/admin/sys-oper-log','/0/2/211/216','C','','admin:sysOperLog:list',211,0,'','/admin/sys-oper-log/index',1,'0','1',0,1,'2021-05-20 22:08:44.526','2022-08-09 16:30:01',NULL);
INSERT INTO sys_menu VALUES(220,'','新增菜单','app-group-fill','','/0/2/51/220','F','','admin:sysMenu:add',51,0,'','',1,'0','1',1,1,'2020-04-11 15:52:48.000','2022-08-09 16:30:01',NULL);
INSERT INTO sys_menu VALUES(221,'','修改菜单','app-group-fill','','/0/2/51/221','F','','admin:sysMenu:edit',51,0,'','',1,'0','1',1,1,'2020-04-11 15:52:48.000','2022-08-09 16:30:01',NULL);
INSERT INTO sys_menu VALUES(222,'','查询菜单','app-group-fill','','/0/2/51/222','F','','admin:sysMenu:query',51,0,'','',1,'0','1',1,1,'2020-04-11 15:52:48.000','2022-08-09 16:30:01',NULL);
INSERT INTO sys_menu VALUES(223,'','删除菜单','app-group-fill','','/0/2/51/223','F','','admin:sysMenu:remove',51,0,'','',1,'0','1',1,1,'2020-04-11 15:52:48.000','2022-08-09 16:30:01',NULL);
INSERT INTO sys_menu VALUES(224,'','新增角色','app-group-fill','','/0/2/52/224','F','','admin:sysRole:add',52,0,'','',1,'0','1',1,1,'2020-04-11 15:52:48.000','2022-08-09 16:30:01',NULL);
INSERT INTO sys_menu VALUES(225,'','查询角色','app-group-fill','','/0/2/52/225','F','','admin:sysRole:query',52,0,'','',1,'0','1',1,1,'2020-04-11 15:52:48.000','2022-08-09 16:30:01',NULL);
INSERT INTO sys_menu VALUES(226,'','修改角色','app-group-fill','','/0/2/52/226','F','','admin:sysRole:update',52,0,'','',1,'0','1',1,1,'2020-04-11 15:52:48.000','2022-08-09 16:30:01',NULL);
INSERT INTO sys_menu VALUES(227,'','删除角色','app-group-fill','','/0/2/52/227','F','','admin:sysRole:remove',52,0,'','',1,'0','1',1,1,'2020-04-11 15:52:48.000','2022-08-09 16:30:01',NULL);
INSERT INTO sys_menu VALUES(228,'','查询部门','app-group-fill','','/0/2/56/228','F','','admin:sysDept:query',56,0,'','',40,'0','1',0,1,'2021-05-20 22:08:44.526','2022-08-09 16:30:01',NULL);
INSERT INTO sys_menu VALUES(229,'','新增部门','app-group-fill','','/0/2/56/229','F','','admin:sysDept:add',56,0,'','',10,'0','1',0,1,'2021-05-20 22:08:44.526','2022-08-09 16:30:01',NULL);
INSERT INTO sys_menu VALUES(230,'','修改部门','app-group-fill','','/0/2/56/230','F','','admin:sysDept:edit',56,0,'','',30,'0','1',0,1,'2021-05-20 22:08:44.526','2022-08-09 16:30:01',NULL);
INSERT INTO sys_menu VALUES(231,'','删除部门','app-group-fill','','/0/2/56/231','F','','admin:sysDept:remove',56,0,'','',20,'0','1',0,1,'2021-05-20 22:08:44.526','2022-08-09 16:30:01',NULL);
INSERT INTO sys_menu VALUES(232,'','查询岗位','app-group-fill','','/0/2/57/232','F','','admin:sysPost:query',57,0,'','',0,'0','1',1,1,'2020-04-11 15:52:48.000','2022-08-09 16:30:01',NULL);
INSERT INTO sys_menu VALUES(233,'','新增岗位','app-group-fill','','/0/2/57/233','F','','admin:sysPost:add',57,0,'','',0,'0','1',1,1,'2020-04-11 15:52:48.000','2022-08-09 16:30:01',NULL);
INSERT INTO sys_menu VALUES(234,'','修改岗位','app-group-fill','','/0/2/57/234','F','','admin:sysPost:edit',57,0,'','',0,'0','1',1,1,'2020-04-11 15:52:48.000','2022-08-09 16:30:01',NULL);
INSERT INTO sys_menu VALUES(235,'','删除岗位','app-group-fill','','/0/2/57/235','F','','admin:sysPost:remove',57,0,'','',0,'0','1',1,1,'2020-04-11 15:52:48.000','2022-08-09 16:30:01',NULL);
INSERT INTO sys_menu VALUES(236,'','查询字典','app-group-fill','','/0/2/58/236','F','','admin:sysDictType:query',58,0,'','',0,'0','1',1,1,'2020-04-11 15:52:48.000','2022-08-09 16:30:01',NULL);
INSERT INTO sys_menu VALUES(237,'','新增类型','app-group-fill','','/0/2/58/237','F','','admin:sysDictType:add',58,0,'','',0,'0','1',1,1,'2020-04-11 15:52:48.000','2022-08-09 16:30:01',NULL);
INSERT INTO sys_menu VALUES(238,'','修改类型','app-group-fill','','/0/2/58/238','F','','admin:sysDictType:edit',58,0,'','',0,'0','1',1,1,'2020-04-11 15:52:48.000','2022-08-09 16:30:01',NULL);
INSERT INTO sys_menu VALUES(239,'','删除类型','app-group-fill','','/0/2/58/239','F','','system:sysdicttype:remove',58,0,'','',0,'0','1',1,1,'2020-04-11 15:52:48.000','2022-08-09 16:30:01',NULL);
INSERT INTO sys_menu VALUES(240,'','查询数据','app-group-fill','','/0/2/59/240','F','','admin:sysDictData:query',59,0,'','',0,'0','1',1,1,'2020-04-11 15:52:48.000','2022-08-09 16:30:01',NULL);
INSERT INTO sys_menu VALUES(241,'','新增数据','app-group-fill','','/0/2/59/241','F','','admin:sysDictData:add',59,0,'','',0,'0','1',1,1,'2020-04-11 15:52:48.000','2022-08-09 16:30:01',NULL);
INSERT INTO sys_menu VALUES(242,'','修改数据','app-group-fill','','/0/2/59/242','F','','admin:sysDictData:edit',59,0,'','',0,'0','1',1,1,'2020-04-11 15:52:48.000','2022-08-09 16:30:01',NULL);
INSERT INTO sys_menu VALUES(243,'','删除数据','app-group-fill','','/0/2/59/243','F','','admin:sysDictData:remove',59,0,'','',0,'0','1',1,1,'2020-04-11 15:52:48.000','2022-08-09 16:30:01',NULL);
INSERT INTO sys_menu VALUES(244,'','查询参数','app-group-fill','','/0/2/62/244','F','','admin:sysConfig:query',62,0,'','',0,'0','1',1,1,'2020-04-11 15:52:48.000','2022-08-09 16:30:01',NULL);
INSERT INTO sys_menu VALUES(245,'','新增参数','app-group-fill','','/0/2/62/245','F','','admin:sysConfig:add',62,0,'','',0,'0','1',1,1,'2020-04-11 15:52:48.000','2022-08-09 16:30:01',NULL);
INSERT INTO sys_menu VALUES(246,'','修改参数','app-group-fill','','/0/2/62/246','F','','admin:sysConfig:edit',62,0,'','',0,'0','1',1,1,'2020-04-11 15:52:48.000','2022-08-09 16:30:01',NULL);
INSERT INTO sys_menu VALUES(247,'','删除参数','app-group-fill','','/0/2/62/247','F','','admin:sysConfig:remove',62,0,'','',0,'0','1',1,1,'2020-04-11 15:52:48.000','2022-08-09 16:30:01',NULL);
INSERT INTO sys_menu VALUES(248,'','查询登录日志','app-group-fill','','/0/2/211/212/248','F','','admin:sysLoginLog:query',212,0,'','',0,'0','1',1,1,'2020-04-11 15:52:48.000','2022-08-09 16:30:01',NULL);
INSERT INTO sys_menu VALUES(249,'','删除登录日志','app-group-fill','','/0/2/211/212/249','F','','admin:sysLoginLog:remove',212,0,'','',0,'0','1',1,1,'2020-04-11 15:52:48.000','2022-08-09 16:30:01',NULL);
INSERT INTO sys_menu VALUES(250,'','查询操作日志','app-group-fill','','/0/2/211/216/250','F','','admin:sysOperLog:query',216,0,'','',0,'0','1',1,1,'2020-04-11 15:52:48.000','2022-08-09 16:30:01',NULL);
INSERT INTO sys_menu VALUES(251,'','删除操作日志','app-group-fill','','/0/2/211/216/251','F','','admin:sysOperLog:remove',216,0,'','',0,'0','1',1,1,'2020-04-11 15:52:48.000','2022-08-09 16:30:01',NULL);
INSERT INTO sys_menu VALUES(261,'Gen','代码生成','code','/dev-tools/gen','/0/60/261','C','','',60,0,'','/dev-tools/gen/index',2,'0','1',1,1,'2020-04-11 15:52:48.000','2022-08-09 16:30:01',NULL);
INSERT INTO sys_menu VALUES(262,'EditTable','代码生成修改','build','/dev-tools/editTable','/0/60/262','C','','',60,0,'','/dev-tools/gen/editTable',100,'1','1',1,1,'2020-04-11 15:52:48.000','2022-08-09 16:30:01',NULL);
INSERT INTO sys_menu VALUES(264,'Build','表单构建','build','/dev-tools/build','/0/60/264','C','','',60,0,'','/dev-tools/build/index',1,'0','1',1,1,'2020-04-11 15:52:48.000','2022-08-09 16:30:01',NULL);
INSERT INTO sys_menu VALUES(269,'ServerMonitor','服务监控','druid','/sys-tools/monitor','/0/537/269','C','','sysTools:serverMonitor:list',537,0,'','/sys-tools/monitor',0,'0','1',1,1,'2020-04-14 00:28:19.000','2022-08-09 16:30:01',NULL);
INSERT INTO sys_menu VALUES(459,'Schedule','定时任务','time-range','/schedule','/0/459','M','无','',0,0,'','Layout',20,'0','1',1,1,'2020-08-03 09:17:37.000','2022-08-09 16:30:01',NULL);
INSERT INTO sys_menu VALUES(460,'ScheduleManage','Schedule','job','/schedule/manage','/0/459/460','C','无','job:sysJob:list',459,0,'','/schedule/index',0,'0','1',1,1,'2020-08-03 09:17:37.000','2022-08-09 16:30:01',NULL);
INSERT INTO sys_menu VALUES(461,'sys_job','分页获取定时任务','app-group-fill','','/0/459/460/461','F','无','job:sysJob:query',460,0,'','',0,'0','1',1,1,'2020-08-03 09:17:37.000','2022-08-09 16:30:01',NULL);
INSERT INTO sys_menu VALUES(462,'sys_job','创建定时任务','app-group-fill','','/0/459/460/462','F','无','job:sysJob:add',460,0,'','',0,'0','1',1,1,'2020-08-03 09:17:37.000','2022-08-09 16:30:01',NULL);
INSERT INTO sys_menu VALUES(463,'sys_job','修改定时任务','app-group-fill','','/0/459/460/463','F','无','job:sysJob:edit',460,0,'','',0,'0','1',1,1,'2020-08-03 09:17:37.000','2022-08-09 16:30:01',NULL);
INSERT INTO sys_menu VALUES(464,'sys_job','删除定时任务','app-group-fill','','/0/459/460/464','F','无','job:sysJob:remove',460,0,'','',0,'0','1',1,1,'2020-08-03 09:17:37.000','2022-08-09 16:30:01',NULL);
INSERT INTO sys_menu VALUES(471,'JobLog','日志','bug','/schedule/log','/0/459/471','C','','',459,0,'','/schedule/log',0,'1','1',1,1,'2020-08-05 21:24:46.000','2022-08-09 16:30:01',NULL);
INSERT INTO sys_menu VALUES(528,'SysApiManage','接口管理','api-doc','/admin/sys-api','/0/2/528','C','无','admin:sysApi:list',2,0,'','/admin/sys-api/index',0,'0','0',0,1,'2021-05-20 22:08:44.526','2022-08-09 16:30:01',NULL);
INSERT INTO sys_menu VALUES(529,'','查询接口','app-group-fill','','/0/2/528/529','F','无','admin:sysApi:query',528,0,'','',40,'0','0',0,1,'2021-05-20 22:08:44.526','2022-08-09 16:30:01',NULL);
INSERT INTO sys_menu VALUES(531,'','修改接口','app-group-fill','','/0/2/528/531','F','无','admin:sysApi:edit',528,0,'','',30,'0','0',0,1,'2021-05-20 22:08:44.526','2022-08-09 16:30:01',NULL);
INSERT INTO sys_menu VALUES(537,'SysTools','系统工具','system-tools','/sys-tools','/0/537','M','','',0,0,'','Layout',30,'0','1',1,1,'2021-05-21 11:13:32.166','2022-08-09 16:30:01',NULL);
INSERT INTO sys_menu VALUES(540,'SysConfigSet','参数设置','system-tools','/admin/sys-config/set','/0/2/540','C','','admin:sysConfigSet:list',2,0,'','/admin/sys-config/set',0,'0','1',1,1,'2021-05-25 16:06:52.560','2022-08-09 16:30:01',NULL);
INSERT INTO sys_menu VALUES(542,'','修改','upload','','/0/2/540/542','F','','admin:sysConfigSet:update',540,0,'','',0,'0','1',1,1,'2021-06-13 11:45:48.670','2022-08-09 16:30:01',NULL);

CREATE TABLE `sys_api` (`id` integer,`handle` text,`title` text,`path` text,`type` text,`action` text,`created_at` datetime,`updated_at` datetime,`deleted_at` datetime,`create_by` integer,`update_by` integer,PRIMARY KEY (`id`));
...
CREATE TABLE `sys_menu_api_rule` (`sys_menu_menu_id` integer,`sys_api_id` integer,PRIMARY KEY (`sys_menu_menu_id`,`sys_api_id`),CONSTRAINT `fk_sys_menu_api_rule_sys_menu` FOREIGN KEY (`sys_menu_menu_id`) REFERENCES `sys_menu`(`menu_id`),CONSTRAINT `fk_sys_menu_api_rule_sys_api` FOREIGN KEY (`sys_api_id`) REFERENCES `sys_api`(`id`));
...
CREATE TABLE `sys_login_log` (`id` integer,`username` varchar(128),`status` varchar(4),`ipaddr` varchar(255),`login_location` varchar(255),`browser` varchar(255),`os` varchar(255),`platform` varchar(255),`login_time` timestamp,`remark` varchar(255),`msg` varchar(255),`created_at` datetime,`updated_at` datetime,`create_by` integer,`update_by` integer,PRIMARY KEY (`id`));
CREATE TABLE `sys_opera_log` (`id` integer,`title` varchar(255),`business_type` varchar(128),`business_types` varchar(128),`method` varchar(128),`request_method` varchar(128),`operator_type` varchar(128),`oper_name` varchar(128),`dept_name` varchar(128),`oper_url` varchar(255),`oper_ip` varchar(128),`oper_location` varchar(128),`oper_param` varchar(255),`status` varchar(4),`oper_time` timestamp,`json_result` varchar(255),`remark` varchar(255),`latency_time` varchar(128),`user_agent` varchar(255),`created_at` datetime,`updated_at` datetime,`create_by` integer,`update_by` integer,PRIMARY KEY (`id`));
CREATE TABLE `sys_role_dept` (`role_id` integer,`dept_id` integer,PRIMARY KEY (`role_id`,`dept_id`));
CREATE TABLE `sys_user` (`user_id` integer,`username` varchar(64),`password` varchar(128),`nick_name` varchar(128),`phone` varchar(11),`role_id` bigint,`salt` varchar(255),`avatar` varchar(255),`sex` varchar(255),`email` varchar(128),`dept_id` bigint,`post_id` bigint,`remark` varchar(255),`status` varchar(4),`create_by` integer,`update_by` integer,`created_at` datetime,`updated_at` datetime,`deleted_at` datetime,PRIMARY KEY (`user_id`));
...
CREATE TABLE `sys_role` (`role_id` integer,`role_name` text,`status` text,`role_key` text,`role_sort` integer,`flag` text,`remark` text,`admin` numeric,`data_scope` text,`create_by` integer,`update_by` integer,`created_at` datetime,`updated_at` datetime,`deleted_at` datetime,PRIMARY KEY (`role_id`));
INSERT INTO sys_role VALUES(1,'系统管理员','2','admin',1,'','',1,'',1,1,'2021-05-13 19:56:37.913','2021-05-13 19:56:37.913',NULL);
CREATE TABLE `sys_role_menu` (`role_id` integer,`menu_id` integer,PRIMARY KEY (`role_id`,`menu_id`),CONSTRAINT `fk_sys_role_menu_sys_role` FOREIGN KEY (`role_id`) REFERENCES `sys_role`(`role_id`),CONSTRAINT `fk_sys_role_menu_sys_menu` FOREIGN KEY (`menu_id`) REFERENCES `sys_menu`(`menu_id`));
CREATE TABLE `sys_post` (`post_id` integer,`post_name` text,`post_code` text,`sort` integer,`status` integer,`remark` text,`create_by` integer,`update_by` integer,`created_at` datetime,`updated_at` datetime,`deleted_at` datetime,PRIMARY KEY (`post_id`));
...
CREATE TABLE `sys_dict_data` (`dict_code` integer,`dict_sort` integer,`dict_label` text,`dict_value` text,`dict_type` text,`css_class` text,`list_class` text,`is_default` text,`status` integer,`default` text,`remark` text,`create_by` integer,`update_by` integer,`created_at` datetime,`updated_at` datetime,`deleted_at` datetime,PRIMARY KEY (`dict_code`));
...
CREATE TABLE `sys_dict_type` (`dict_id` integer,`dict_name` text,`dict_type` text,`status` integer,`remark` text,`create_by` integer,`update_by` integer,`created_at` datetime,`updated_at` datetime,`deleted_at` datetime,PRIMARY KEY (`dict_id`));
...
CREATE TABLE `sys_job` (`job_id` integer,`job_name` text,`job_group` text,`job_type` integer,`cron_expression` text,`invoke_target` text,`args` text,`misfire_policy` integer,`concurrent` integer,`status` integer,`entry_id` integer,`created_at` datetime,`updated_at` datetime,`deleted_at` datetime,`create_by` integer,`update_by` integer,PRIMARY KEY (`job_id`));
...
CREATE TABLE `tb_demo` (`id` integer,`name` varchar(128),`created_at` datetime,`updated_at` datetime,`deleted_at` datetime,`create_by` integer,`update_by` integer,PRIMARY KEY (`id`));

CREATE TABLE `sys_migration` (`version` text,`apply_time` datetime);

INSERT INTO sys_migration VALUES('1599190683659','2022-08-09 16:30:01');
INSERT INTO sys_migration VALUES('1653638869132','2022-08-09 16:30:01');
...
CREATE INDEX `idx_sys_dept_update_by` ON `sys_dept`(`update_by`);
CREATE INDEX `idx_sys_dept_create_by` ON `sys_dept`(`create_by`);
CREATE INDEX `idx_sys_config_update_by` ON `sys_config`(`update_by`);
CREATE INDEX `idx_sys_config_create_by` ON `sys_config`(`create_by`);
CREATE INDEX `idx_sys_config_deleted_at` ON `sys_config`(`deleted_at`);
CREATE INDEX `idx_sys_tables_update_by` ON `sys_tables`(`update_by`);
CREATE INDEX `idx_sys_tables_create_by` ON `sys_tables`(`create_by`);
CREATE INDEX `idx_sys_tables_deleted_at` ON `sys_tables`(`deleted_at`);
CREATE INDEX `idx_sys_columns_update_by` ON `sys_columns`(`update_by`);
CREATE INDEX `idx_sys_columns_create_by` ON `sys_columns`(`create_by`);
CREATE INDEX `idx_sys_columns_deleted_at` ON `sys_columns`(`deleted_at`);
CREATE INDEX `idx_sys_menu_deleted_at` ON `sys_menu`(`deleted_at`);
CREATE INDEX `idx_sys_menu_update_by` ON `sys_menu`(`update_by`);
CREATE INDEX `idx_sys_menu_create_by` ON `sys_menu`(`create_by`);
CREATE INDEX `idx_sys_api_update_by` ON `sys_api`(`update_by`);
CREATE INDEX `idx_sys_api_create_by` ON `sys_api`(`create_by`);
CREATE INDEX `idx_sys_api_deleted_at` ON `sys_api`(`deleted_at`);
CREATE INDEX `idx_sys_login_log_update_by` ON `sys_login_log`(`update_by`);
CREATE INDEX `idx_sys_login_log_create_by` ON `sys_login_log`(`create_by`);
CREATE INDEX `idx_sys_opera_log_update_by` ON `sys_opera_log`(`update_by`);
CREATE INDEX `idx_sys_opera_log_create_by` ON `sys_opera_log`(`create_by`);
CREATE INDEX `idx_sys_user_deleted_at` ON `sys_user`(`deleted_at`);
CREATE INDEX `idx_sys_user_update_by` ON `sys_user`(`update_by`);
CREATE INDEX `idx_sys_user_create_by` ON `sys_user`(`create_by`);
CREATE INDEX `idx_sys_role_deleted_at` ON `sys_role`(`deleted_at`);
CREATE INDEX `idx_sys_role_update_by` ON `sys_role`(`update_by`);
CREATE INDEX `idx_sys_role_create_by` ON `sys_role`(`create_by`);
CREATE INDEX `idx_sys_post_deleted_at` ON `sys_post`(`deleted_at`);
CREATE INDEX `idx_sys_post_update_by` ON `sys_post`(`update_by`);
CREATE INDEX `idx_sys_post_create_by` ON `sys_post`(`create_by`);
CREATE INDEX `idx_sys_dict_data_deleted_at` ON `sys_dict_data`(`deleted_at`);
CREATE INDEX `idx_sys_dict_data_update_by` ON `sys_dict_data`(`update_by`);
CREATE INDEX `idx_sys_dict_data_create_by` ON `sys_dict_data`(`create_by`);
CREATE INDEX `idx_sys_dict_type_create_by` ON `sys_dict_type`(`create_by`);
CREATE INDEX `idx_sys_dict_type_deleted_at` ON `sys_dict_type`(`deleted_at`);
CREATE INDEX `idx_sys_dict_type_update_by` ON `sys_dict_type`(`update_by`);
CREATE INDEX `idx_sys_job_update_by` ON `sys_job`(`update_by`);
CREATE INDEX `idx_sys_job_create_by` ON `sys_job`(`create_by`);
CREATE INDEX `idx_sys_job_deleted_at` ON `sys_job`(`deleted_at`);
CREATE INDEX `idx_tb_demo_update_by` ON `tb_demo`(`update_by`);
CREATE INDEX `idx_tb_demo_create_by` ON `tb_demo`(`create_by`);
CREATE INDEX `idx_tb_demo_deleted_at` ON `tb_demo`(`deleted_at`);
COMMIT;
